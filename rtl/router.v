module router(
   ...
   matrix_5_arb proc_arb ( .clk(clk), .rst_n(rst_n), .req(req_p), .grant(grant_p));
   matrix_5_arb east_arb ( .clk(clk), .rst_n(rst_n), .req(req_e), .grant(grant_e));
   matrix_5_arb south_arb( .clk(clk), .rst_n(rst_n), .req(req_s), .grant(grant_s));
   matrix_5_arb west_arb ( .clk(clk), .rst_n(rst_n), .req(req_w), .grant(grant_w));
   matrix_5_arb north_arb( .clk(clk), .rst_n(rst_n), .req(req_n), .grant(grant_n));
